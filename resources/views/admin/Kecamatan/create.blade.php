                ...
                <div class="row">
                    ...
                    <div class="col-xxl">
                        <div class="card mb-4">
                            ...
                            <div class="card-body">
                                <form action="/dashboard/kecamatan" enctype="multipart/form-data" method="post">
                                    @csrf
                                    <div class="row mb-3">
                                        <label class="col-sm-2 col-form-label" for="basic-default-name">Kode
                                            Kecamatan</label>
                                        <div class="col-sm-10">
                                            <input type="text" value="{{ old('kode_kecamatan') }}"
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="file" value="{{ old('file_geo_json') }}" name="file_geo_json"
                                                class="form-control">
                                        </div>
                                        @error('file_geo_json')
                                            <div class="text-danger">{{ $message }}</div>
